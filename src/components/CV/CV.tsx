  ...
  useEffect(() => {
    axios
      ...
      .then(async (res) => {
        ...
        setTextContent(
          selectedLanguage === "eng" ? res.data.eng : res.data.hun
        );
      });
  }, []);
        ...
        <>
          <div className={"personal-informations"}>
            ...
            <div className="about-me">
              ...
              <p>
                Szeretem ahogy a terveket követve valami alakul a kezem alatt,
                de ha a váratlan keresztül húzza a számításokat, akkor sem esem
                kétségbe.
              </p>
              <p>
